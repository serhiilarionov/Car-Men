...
class EntrustSetupTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('auth_role_auth_user', function (Blueprint $table) {
        ...
        Schema::create('auth_permission_auth_role', function (Blueprint $table) {
    ...
    {
        Schema::drop('auth_permission_auth_role');
        Schema::drop('auth_permissions');
        Schema::drop('auth_role_auth_user');
